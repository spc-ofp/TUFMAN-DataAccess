...
namespace TUFMAN.Domain.Ves {
    ...
    public class Vessels {
        ...
        public Countries flag_code { get; set; }
        public Countries flag_conv_code { get; set; }
        ...
        public string vessel_category_code { get; set; }
        public string standard_vessel_name { get; set; }
        public string builder_name { get; set; }
        public decimal? net_tonnage { get; set; }
        public string construct_material { get; set; }
        public string inmarsat_imn { get; set; }
        public string inmarsat_maker { get; set; }
        public string inmarsat_model { get; set; }
        public string inmarsat_serial_no { get; set; }
        public string inmarsat_security_no { get; set; }
    }
}
